...
def inc_end():
    ...
    state_dict["Statistics"]["Stamina Regeneration/s"].set(state_dict["Statistics"]["Stamina Regeneration/s"].get() + 1.5)
...
def inc_spi():
    ...
    state_dict["Statistics"]["Mana Regeneration/s"].set(state_dict["Statistics"]["Mana Regeneration/s"].get() + 0.3)
...
def inc_pra():
    ...
    state_dict["Invested_attribute_points"].set(state_dict["Invested_attribute_points"].get() + 1)
    update_level()
    state_dict["Statistics"]["Alchemy Bonus"].set(state_dict["Statistics"]["Alchemy Bonus"].get() + 0.1)
    state_dict["Statistics"]["Cooking Bonus"].set(state_dict["Statistics"]["Cooking Bonus"].get() + 0.1)
    state_dict["Statistics"]["Handcrafting Bonus"].set(state_dict["Statistics"]["Handcrafting Bonus"].get() + 0.1)
